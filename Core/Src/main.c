...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	SPLC780D_t my_char_display = {
			.E_Port = SPLC780D_E_GPIO_Port,
			.E_Pin = SPLC780D_E_Pin,

			.RW_Port = SPLC780D_RW_GPIO_Port,
			.RW_Pin = SPLC780D_RW_Pin,

			.RS_Port = SPLC780D_RS_GPIO_Port,
			.RS_Pin = SPLC780D_RS_Pin,
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, WS2812B_D_Pin|SPLC780D_RS_Pin|SPLC780D_RW_Pin|SPLC780D_E_Pin, GPIO_PIN_RESET);
